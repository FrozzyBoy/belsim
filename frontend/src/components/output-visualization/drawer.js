// let dataFromFile = require('./data.js');
// let drawContent = require('./graph-content').drawContent;

// function drawer() {
//   let data = [];
//   dataFromFile.forEach((el, index) => {
//     if (index < 10) {
//       let graph = el.timedValue.map((x) => {
//         return {
//           date: Number(x.time),
//           temperature: Number(x.value)
//         }
//       });
//       data.push(graph);
//     }
...
var dataParsed = require('./data-parsed');
...
function drawAll() {
  ...
  var svg = d3.select("#output-visialization").append("svg")
